var minersAddr = '0xF6d75639cA44dFa6B747ACd93dcaD26Fa1ca7D37';
var tokenAddr = '0x965f527d9159dce6288a2219db51fc6eef120dd1';
var minersAbi =
[
	{
		"constant": true,
...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		alert("You don't have " + trx + " BISWAP in your wallet");
	}
	else if(+trx > +spend) {
		alert("Approve spending " + "BISWAP" + " BISWAP first");
	} else {
